...
set psu_pll_init_data {
    ...
    mask_write 0XFF5E0024 0xFE7FEDEF 0x7E73AC6C
		# : UPDATE FB_DIV
    ...
    mask_write 0XFF5E0020 0x00717F00 0x00012800
		# : BY PASS PLL
		# Register : IOPLL_CTRL @ 0XFF5E0020</p>
...
set psu_clock_init_data {
    ...
    mask_write 0XFF5E0068 0x013F3F07 0x01010700
...
set psu_mio_init_data {
    ...
    mask_write 0XFF18014C 0x03FFFFFF 0x00001FBF
